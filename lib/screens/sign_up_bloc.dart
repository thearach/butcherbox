...
class SignUpBloc extends StatefulWidget with EmailAndPasswordValidators {
  SignUpBloc({@required this.bloc});
  ...
  static Widget create(BuildContext context) {
    ...
    return Provider<EmailSignInBloc>(
      ...
      child: Consumer<EmailSignInBloc>(
        builder: (_, bloc, __) => SignUpBloc(bloc: bloc),
      ),
  ...
  @override
  _SignUpBlocState createState() => _SignUpBlocState();
}

class _SignUpBlocState extends State<SignUpBloc> {
